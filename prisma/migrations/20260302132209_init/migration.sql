/*
  ...
  - You are about to drop the column `pagePath` on the `leads` table. All the data in the column will be lost.
  - You are about to drop the column `pageUrl` on the `leads` table. All the data in the column will be lost.
  - You are about to drop the column `referrer` on the `leads` table. All the data in the column will be lost.
